...
public enum DateParam {
    ...
    HOUR_P("hour_p", "firstSecondThisHour", "HH"),
    MONTH_P("month_p", "today", "yyyyMM"),
    FIRST_SECOND_THIS_HOUR("first_second_this_hour", "firstSecondThisHour", "yyyy-MM-dd HH:mm:ss"),
    LAST_SECOND_THIS_HOUR("last_second_this_hour", "lastSecondThisHour", "yyyy-MM-dd HH:mm:ss"),
