...
//        TaskFull taskFull = taskService.getFullTaskByCode("whaley_membership_renew_ytd");
//        System.out.println(taskFull.getTaskCode());
//        System.out.println(taskFull.getExecuteTypeList());
//        System.out.println(taskFull.getCreateTime());
...
//        System.out.println(tableName);
        ...
        System.out.println(dbInfoWithStorage.getStorageId());
        System.out.println(dbInfoWithStorage.getStorageType());
        System.out.println(dbInfoWithStorage.getAddress());
        System.out.println(dbInfoWithStorage.getUser());
        System.out.println(dbInfoWithStorage.getPassword());
    }
}
