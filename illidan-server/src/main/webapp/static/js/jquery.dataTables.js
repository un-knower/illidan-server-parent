...
(/** @lends <global> */function( $ ) {
	...
	/**
	 * Get/Set the data submitted in the last Ajax request
	 */
	_api_register( 'ajax.params()', function (paramObj) {
		var ctx = this.context;
	
	    if(paramObj){
		    if ( ctx.length > 0 && ctx[0].ajax && ctx[0].ajax.data) {
			    ctx[0].ajax.data = paramObj;
		    }
		}else{
			if ( ctx.length > 0 ) {
