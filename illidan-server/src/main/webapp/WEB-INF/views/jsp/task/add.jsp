...
<div class="container theme-showcase form-horizontal" role="main">
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <%--<div class="col-sm-6">--%>
                <%--<div class="form-group">--%>
                    <%--<label class="col-md-2 control-label">所属任务组</label>--%>
                    <%--<div class="col-md-6">--%>
                        <%--<select id="groupId" name="groupId" class="selectpicker show-tick form-control" data-live-search="true">--%>
                            <%--<c:forEach begin="0" end="${group.size()-1}"  var="index">--%>
                                <%--<option value ="${group.get(index).id}" >${group.get(index).groupCode}</option>--%>
                            <%--</c:forEach>--%>
                        <%--</select>--%>
                    <%--</div>--%>
                <%--</div>--%>
...
//        fieldInfo.colName = $("#partitionCol").val().toString().split(",");
